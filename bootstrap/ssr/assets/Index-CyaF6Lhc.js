...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><div class="bg-white rounded-md shadow overflow-x-auto"><table class="w-full whitespace-nowrap"><tbody><tr class="text-left font-bold"><th class="pb-4 pt-6 px-6">${ssrInterpolate(_ctx.$t("Title"))}</th><th class="pb-4 pt-6 px-6">${ssrInterpolate(_ctx.$t("Expires At"))}</th><th class="pb-4 pt-6 px-6">${ssrInterpolate(_ctx.$t("Created At"))}</th><th class="pb-4 pt-6 px-6" colspan="2">${ssrInterpolate(_ctx.$t("Actions"))}</th></tr><!--[-->`);
  ssrRenderList($props.notifications.data, (notification) => {
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(notification.title)}`);
        } else {
          return [
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(notification.expires_at)}`);
        } else {
          return [
            createTextVNode(toDisplayString(notification.expires_at), 1)
          ];
        }
      }),
      _: 2
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(notification.created_at)}`);
        } else {
          return [
  ...
  if ($props.notifications.data.length === 0) {
    _push(`<tr><td class="px-6 py-4 border-t" colspan="4">${ssrInterpolate(_ctx.$t("No notifications found."))}</td></tr>`);
  } else {
    _push(`<!---->`);
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/UserNotifications/Index.vue");
