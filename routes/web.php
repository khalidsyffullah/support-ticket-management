...
Route::prefix('dashboard')->group(function () {
    ...
    Route::get('ticket/csv/export', [TicketsController::class, 'csvExport'])->name('ticket.csv.export')
        ->middleware('auth');
            ...
            Route::get('/dashboard/ticket/csv/export-filtered', [TicketsController::class, 'csvExportFiltered'])->name('tickets.export.filtered');
...
// Organizations
    ...
    Route::get('tickets/builder', [\App\Http\Controllers\TicketFieldsController::class, 'index'])->name('tickets.builder');
