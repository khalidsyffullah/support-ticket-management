...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList($props.users.data, (user) => {
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(user.organization ? _ctx.$t(user.organization) : "")}`);
        } else {
          return [
            createTextVNode(toDisplayString(user.organization ? _ctx.$t(user.organization) : ""), 1)
          ];
        }
      }),
      _: 2
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(user.created_at ? _ctx.$t(user.created_at) : "")}`);
        } else {
          return [
            createTextVNode(toDisplayString(user.created_at ? _ctx.$t(user.created_at) : ""), 1)
          ];
        }
      }),
      _: 2
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(user.approval_status ? _ctx.$t(user.approval_status) : "")}`);
        } else {
          return [
            createTextVNode(toDisplayString(user.approval_status ? _ctx.$t(user.approval_status) : ""), 1)
          ];
        }
      }),
      _: 2
