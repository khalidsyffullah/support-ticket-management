import { D as Dropdown, I as Icon } from "./Dropdown-r9pN8E8G.js";
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderSlot, ssrRenderStyle } from "vue/server-renderer";
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</ul></div></div><div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-3/12"><div class="mb-10 w-full"><h4 class="mb-9 text-lg font-semibold text-white">${ssrInterpolate(_ctx.$t("Useful Links"))}</h4><ul>`);
  if (!!this.enable_option && this.enable_option.terms_of_services) {
    _push(`<li><a${ssrRenderAttr("href", _ctx.route("terms_service"))} class="mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary">${ssrInterpolate(_ctx.$t("Terms of Services"))}</a></li>`);
  } else {
    _push(`<!---->`);
  }
  if (!!this.enable_option && this.enable_option.privacy_policy) {
    _push(`<li><a${ssrRenderAttr("href", _ctx.route("privacy"))} class="mb-2 inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary">${ssrInterpolate(_ctx.$t("Privacy Policy"))}</a></li>`);
  } else {
    _push(`<!---->`);
  }
  if (!!this.enable_option && this.enable_option.kb) {
