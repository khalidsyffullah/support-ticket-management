...
import { L as Layout } from "./Layout--M59mIZ5.js";
...
/* empty css                        */
import { resolveComponent, withCtx, createTextVNode, toDisplayString, createVNode, createBlock, openBlock, Fragment, renderList, useSSRContext } from "vue";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($data.html.sections[2].enable_ticket_section) {
    ...
    _push(ssrRenderComponent(_component_select_input, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<option${ssrRenderAttr("value", null)}${_scopeId}>${ssrInterpolate(_ctx.$t("Select a departmentzzz"))}</option><!--[-->`);
          ...
          return [
            createVNode("option", { value: null }, toDisplayString(_ctx.$t("Select a departmentzzz")), 1),
