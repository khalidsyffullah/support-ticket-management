...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></form></div><h2 class="mt-12 text-2xl font-bold">${ssrInterpolate(_ctx.$t("Customers"))}</h2><div class="mt-6 bg-white rounded shadow overflow-x-auto"><table class="w-full whitespace-nowrap"><tbody><tr class="text-left font-bold"><th class="pb-4 pt-6 px-6">${ssrInterpolate(_ctx.$t("Name"))}</th><th class="pb-4 pt-6 px-6">${ssrInterpolate(_ctx.$t("Email"))}</th><th class="pb-4 pt-6 px-6" colspan="2">${ssrInterpolate(_ctx.$t("Phone"))}</th></tr><!--[-->`);
  ssrRenderList($props.organization.customers, (customer) => {
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(customer.email)}`);
        } else {
          return [
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(customer.phone)}`);
        } else {
          return [
  ...
  _push(`<!--]-->`);
  if ($props.organization.customers.length === 0) {
    _push(`<tr><td class="px-6 py-4 border-t" colspan="4">No customers found.</td></tr>`);
  } else {
    _push(`<!---->`);
  }
