...
/* empty css                        */
import { resolveComponent, withCtx, createVNode, toDisplayString, createBlock, createCommentVNode, openBlock, useSSRContext } from "vue";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($props.chat) {
    ...
    _push(ssrRenderComponent(_component_QuillEditor, {
      ...
      "onUpdate:content": ($event) => $data.message = $event,
      contentType: "html"
    }, null, _parent));
